...
.config(function($stateProvider, $httpProvider, RestangularProvider) {
  ...
  .state('publicshelves', {
    ...
    views: {
      'page': {
        templateUrl: 'partial/publicshelves.html',
        controller: 'PublicShelves'
      }
    }
  })
  .state('publicshelvesView', {
    url: '/publicshelves/:tagId',
    views: {
      'page': {
        templateUrl: 'partial/publicshelves.html',
        controller: 'PublicShelves'
  ...
  .state('publicshelvesbookview', {
    url: '/publicshelves/view/:id',
    views: {
      'page': {
        templateUrl: 'partial/publicshelves.bookview.html',
        controller: 'PublicShelvesBookView'
      }
    }
  })
  .state('settings', {
    ...
    // New states for CommonLibrary
    .state('commonlibrary.all', {
      url: '/all',
      views: {
        'commonlibrary': {
          templateUrl: 'partial/commonlibrary.all.html',
          controller: 'CommonLibraryAll'
        }
      }
    })
    .state('commonlibrary.add', {
      url: '/add',
      views: {
        'commonlibrary': {
          templateUrl: 'partial/commonlibrary.add.html',
          controller: 'CommonLibraryAdd'
        }
      }
    })
    .state('commonlibrary.toprated', {
      url: '/toprated',
      views: {
        'commonlibrary': {
          templateUrl: 'partial/commonlibrary.toprated.html',
          controller: 'TopRatedBooks'
        }
      }
    })
    .state('commonlibrary.filter', {
      url: '/filter',
      views: {
        'commonlibrary': {
          templateUrl: 'partial/commonlibrary.filter.html',
          controller: 'CommonLibraryFilter'
        }
      }
    })
    .state('commonbookaddmanual', {
      url: '/commonbook/addmanual',
      views: {
          'page': {
            templateUrl: 'partial/commonbook.edit.html',
            controller: 'AddCommonBookManual'
          }
      }
    })
    .state('commonbookview', {
      url: '/commonbook/view/:id',
      views: {
          'page': {
            templateUrl: 'partial/commonbook.view.html',
            controller: 'CommonBookView'
          }
      }
    })
    .state('commonbookedit', {
      url: '/commonbook/edit/:id',
      views: {
        'page': {
          templateUrl: 'partial/commonbook.edit.html',
          controller: 'CommonBookEdit'
        }
      }
    });
