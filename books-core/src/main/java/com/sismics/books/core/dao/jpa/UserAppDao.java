...
public class UserAppDao {
    ...
    public List<UserAppDto> findByUserId(String userId) {
        ...
        sb.append(" left join T_USER_APP ua on(ua.USA_IDUSER_C = :userId and ua.USA_DELETEDATE_D is null)");
    ...
    public List<UserAppDto> findConnectedByUserId(String userId) {
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        StringBuilder sb = new StringBuilder("select ua.USA_ID_C, ua.USA_ACCESSTOKEN_C, ua.USA_USERNAME_C, ua.USA_SHARING_B ");
    ...
    public List<UserAppDto> findByAppId(String appId) {
        ...
        sb.append(" ua.USA_DELETEDATE_D is null ");
